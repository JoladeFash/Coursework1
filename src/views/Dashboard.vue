<template>
  <div class="container mt-4">
    ...
    <div class="mx-auto">
      <h3>Search for extra curricular classes</h3>
      ...
      <form class="form-inline row">
        ...
        <div class="col-md-4">
          ...
          <select class="w-100 custom-select my-1 mr-sm-2" v-model="timeLength">
            <option selected>Select</option>
            <option value="15">less than 10 mins</option>
            <option value="30">less than 20 mins</option>
            <option value="45">less than 30 mins</option>
            <option value="60">less than 40 mins</option>
          </select>
        </div>
      ...
      <section v-else>
        <h3> No Activity or Course found</h3>
      </section>
